//! Floating VariablesPanel press dispatch on the web host — mirrors
//! the native `widget_host/variables_panel_press.rs` (#21: the wasm
//! build gets the same interactive grid as the desktop). Row-cell
