...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "ลงชื่อเข้าใช้ OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "อัปเดตไฟล์ OpenPencil นี้หรือไม่?",
        "dialog.upgradeOpBody" => "“{{name}}” ใช้รูปแบบ OpenPencil รุ่นเก่าที่ได้รับการซ่อมแซมขณะเปิด\n\nใช่ = แทนที่ด้วยรูปแบบปัจจุบัน · ไม่ = เก็บต้นฉบับและสร้างสำเนาที่มีหมายเลข · ยกเลิก = เปิดโดยไม่แปลง",
        "figma.overwriteTitle" => "มีไฟล์ OpenPencil อยู่แล้ว",
        ...
        "menu.githubLink" => "OpenPencil บน GitHub",
