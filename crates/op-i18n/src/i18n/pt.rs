...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Entrar no OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "Atualizar este arquivo do OpenPencil?",
        "dialog.upgradeOpBody" => "“{{name}}” usa uma representação antiga do OpenPencil que foi reparada durante a abertura.\n\nSim = Substituir pelo formato atual · Não = Manter o original e criar uma cópia numerada · Cancelar = Abrir sem converter.",
        "figma.overwriteTitle" => "O arquivo do OpenPencil já existe",
        ...
        "menu.githubLink" => "OpenPencil no GitHub",
