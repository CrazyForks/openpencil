...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Masuk ke OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "Perbarui file OpenPencil ini?",
        "dialog.upgradeOpBody" => "“{{name}}” menggunakan representasi OpenPencil lama yang diperbaiki saat dibuka.\n\nYa = Ganti dengan format saat ini · Tidak = Pertahankan file asli dan buat salinan bernomor · Batal = Buka tanpa mengonversi.",
        "figma.overwriteTitle" => "File OpenPencil sudah ada",
        ...
        "menu.view" => "Tampilan",
        "menu.help" => "Bantuan",
        "menu.quit" => "Keluar dari OpenPencil",
        "menu.new" => "Baru",
        "menu.open" => "Buka…",
        ...
        "menu.githubLink" => "OpenPencil di GitHub",
