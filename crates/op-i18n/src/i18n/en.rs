...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "figma.overwriteTitle" => "OpenPencil file already exists",
        ...
        "dialog.upgradeOpTitle" => "Update this OpenPencil file?",
        "dialog.upgradeOpBody" => "“{{name}}” uses a legacy OpenPencil representation that was repaired while opening.\n\nYes = Replace with the current format · No = Keep the original and create a numbered copy · Cancel = Open without converting.",
        ...
        "menu.githubLink" => "OpenPencil on GitHub",
