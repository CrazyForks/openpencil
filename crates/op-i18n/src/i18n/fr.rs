...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Se connecter à OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "Mettre à jour ce fichier OpenPencil ?",
        "dialog.upgradeOpBody" => "« {{name}} » utilise une ancienne représentation OpenPencil qui a été réparée lors de l’ouverture.\n\nOui = Remplacer par le format actuel · Non = Conserver l’original et créer une copie numérotée · Annuler = Ouvrir sans convertir.",
        "figma.overwriteTitle" => "Un fichier OpenPencil existe déjà",
        ...
        "menu.githubLink" => "OpenPencil sur GitHub",
