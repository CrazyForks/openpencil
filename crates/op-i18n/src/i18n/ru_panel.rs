...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sceneTemplate.item.minimalKeynote.summary" => "Много воздуха, огромный кегль, одна мысль на полосу — восемь страниц без единой карточки. Для запусков и докладов.",
