...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "OpenPencil'de oturum aç",
        ...
        "dialog.upgradeOpTitle" => "Bu OpenPencil dosyası güncellensin mi?",
        "dialog.upgradeOpBody" => "“{{name}}”, açılırken onarılan eski bir OpenPencil gösterimi kullanıyor.\n\nEvet = Geçerli biçimle değiştir · Hayır = Özgün dosyayı koru ve numaralı bir kopya oluştur · İptal = Dönüştürmeden aç.",
        "figma.overwriteTitle" => "OpenPencil dosyası zaten var",
        ...
        "menu.githubLink" => "GitHub'da OpenPencil",
