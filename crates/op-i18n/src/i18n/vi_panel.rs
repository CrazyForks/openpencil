...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sceneTemplate.item.minimalKeynote.summary" => "Nhiều khoảng trắng, chữ cực lớn, mỗi trang một ý — tám trang không dùng một thẻ nào. Dành cho ra mắt và diễn thuyết.",
