...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Bei OpenPencil anmelden",
        ...
        "dialog.upgradeOpTitle" => "Diese OpenPencil-Datei aktualisieren?",
        "dialog.upgradeOpBody" => "„{{name}}“ verwendet eine ältere OpenPencil-Darstellung, die beim Öffnen repariert wurde.\n\nJa = Durch das aktuelle Format ersetzen · Nein = Original behalten und nummerierte Kopie erstellen · Abbrechen = Ohne Konvertierung öffnen.",
        "figma.overwriteTitle" => "OpenPencil-Datei ist bereits vorhanden",
        ...
        "menu.githubLink" => "OpenPencil auf GitHub",
