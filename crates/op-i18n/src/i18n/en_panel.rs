...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sceneTemplate.item.minimalKeynote.summary" => "White space, oversized type, one idea per slide — eight pages without a single card. Built for launches and keynotes.",
