...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sceneTemplate.item.minimalKeynote.summary" => "Espacio en blanco, tipografía enorme y una idea por página: ocho páginas sin una sola tarjeta. Para lanzamientos y conferencias.",
