...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sceneTemplate.item.minimalKeynote.summary" => "Bol boşluk, devasa tipografi, sayfa başına tek fikir — sekiz sayfa boyunca tek bir kart yok. Lansman ve açılış konuşmaları için.",
