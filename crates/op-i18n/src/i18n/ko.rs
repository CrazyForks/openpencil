...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "OpenPencil에 로그인",
        ...
        "dialog.upgradeOpTitle" => "이 OpenPencil 파일을 업데이트할까요?",
        "dialog.upgradeOpBody" => "“{{name}}”은(는) 여는 동안 복구된 이전 OpenPencil 형식을 사용합니다.\n\n예 = 현재 형식으로 교체 · 아니요 = 원본을 유지하고 번호가 붙은 복사본 생성 · 취소 = 변환하지 않고 열기.",
        "figma.overwriteTitle" => "OpenPencil 파일이 이미 있습니다",
        ...
        "menu.githubLink" => "GitHub에서 OpenPencil 보기",
