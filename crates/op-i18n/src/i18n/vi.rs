...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Đăng nhập vào OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "Cập nhật tệp OpenPencil này?",
        "dialog.upgradeOpBody" => "“{{name}}” sử dụng biểu diễn OpenPencil cũ đã được sửa chữa khi mở.\n\nCó = Thay bằng định dạng hiện tại · Không = Giữ bản gốc và tạo bản sao có đánh số · Hủy = Mở mà không chuyển đổi.",
        "figma.overwriteTitle" => "Tệp OpenPencil đã tồn tại",
        ...
        "menu.githubLink" => "OpenPencil trên GitHub",
