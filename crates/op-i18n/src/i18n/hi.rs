...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "OpenPencil में साइन इन करें",
        ...
        "dialog.upgradeOpTitle" => "क्या इस OpenPencil फ़ाइल को अपडेट करना है?",
        "dialog.upgradeOpBody" => "“{{name}}” OpenPencil के पुराने रूप का उपयोग करती है, जिसे खोलते समय सुधारा गया था।\n\nहाँ = मौजूदा प्रारूप से बदलें · नहीं = मूल फ़ाइल रखें और क्रमांकित प्रति बनाएँ · रद्द करें = बदले बिना खोलें।",
        "figma.overwriteTitle" => "OpenPencil फ़ाइल पहले से मौजूद है",
        ...
        "menu.githubLink" => "GitHub पर OpenPencil",
