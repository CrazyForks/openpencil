...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "OpenPencil にサインイン",
        ...
        "dialog.upgradeOpTitle" => "この OpenPencil ファイルを更新しますか？",
        "dialog.upgradeOpBody" => "「{{name}}」は開く際に修復された旧形式の OpenPencil データを使用しています。\n\nはい = 現在の形式で置換 · いいえ = 元のファイルを残して番号付きコピーを作成 · キャンセル = 変換せずに開く。",
        "figma.overwriteTitle" => "同名の OpenPencil ファイルが既にあります",
        ...
        "menu.githubLink" => "GitHub で OpenPencil を見る",
