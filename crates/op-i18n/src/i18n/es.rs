...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Iniciar sesión en OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "¿Actualizar este archivo de OpenPencil?",
        "dialog.upgradeOpBody" => "«{{name}}» usa una representación antigua de OpenPencil que se reparó al abrirla.\n\nSí = Reemplazar por el formato actual · No = Conservar el original y crear una copia numerada · Cancelar = Abrir sin convertir.",
        "figma.overwriteTitle" => "El archivo de OpenPencil ya existe",
        ...
        "menu.githubLink" => "OpenPencil en GitHub",
