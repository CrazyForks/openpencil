...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "account.signInTitle" => "Вход в OpenPencil",
        ...
        "dialog.upgradeOpTitle" => "Обновить этот файл OpenPencil?",
        "dialog.upgradeOpBody" => "Файл «{{name}}» использует старое представление OpenPencil, исправленное при открытии.\n\nДа = Заменить текущим форматом · Нет = Сохранить оригинал и создать нумерованную копию · Отмена = Открыть без преобразования.",
        "figma.overwriteTitle" => "Файл OpenPencil уже существует",
        ...
        "menu.view" => "Вид",
        "menu.help" => "Справка",
        "menu.quit" => "Завершить OpenPencil",
        "menu.new" => "Создать",
        "menu.open" => "Открыть…",
        ...
        "menu.githubLink" => "OpenPencil на GitHub",
